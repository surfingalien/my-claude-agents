...
Use for surgical fixes: correcting a single formula, patching an auth bug, fixing a miscalculated P&L value. Hard refuses 3+ file scope — for broader FinSurfing refactors, use the main thread or `do`.
