...
Primary use case: locating Finnhub API call sites, portfolio calculation functions, auth middleware, and React component trees before making targeted edits. Runs on Haiku — fast and cheap for read-only investigation.
